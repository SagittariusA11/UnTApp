...
class UPI_Payment extends StatefulWidget {
  ...
  @override
  State<UPI_Payment> createState() => _UPI_PaymentState();
}
...
class _UPI_PaymentState extends State<UPI_Payment> {
  ...
  Widget build(BuildContext context) {
    UPI_Payment upiPayment = widget;
    String receiverUpiID = upiPayment.receiverUpiID;
    String receiverName = upiPayment.receiverName;
    double amount = upiPayment.amount;
    return Scaffold(
      appBar: AppBar(
        title: Text('UPI'),
      ),
